 ...
 public class gamePlayGUIL3 {
     ...
     public static void main(String[] args) {
         EventQueue.invokeLater(new Runnable() {
             public void run() {
                 try {
                     gamePlayGUIL3 window = new gamePlayGUIL3(points);
      ...
      */
     public gamePlayGUIL3(int point) {
         initialize(point);
     }
      ...
      */
     private void initialize(int point) {
         ...
         l.setTitle("Level 3 (" + points + " Points)");
         ...
         btnEnter.addActionListener(new ActionListener() {
             public void actionPerformed(ActionEvent e) {
                 ...
                 if(game.timerFinished) {
                     ...
                     JOptionPane.showMessageDialog(null, "Thank you for playing your Final Score is: " + points);
                     System.exit(0);
